...
BEGIN
    ...
    BEGIN TRY
        ...
        -- start the timer for the complete Silver loading process
        ...
        -- clean and load customer information
        ...
        -- clean and load product information
        SET @start_time = GETDATE();
        ...
        -- clean and load sales information
        SET @start_time = GETDATE();
        ...
        -- clean and load ERP customer information
        SET @start_time = GETDATE();
        ...
        -- clean and load ERP location information
        SET @start_time = GETDATE();
        ...
        -- clean and load ERP product category information
        SET @start_time = GETDATE();
        ...
        -- calculate the total Silver loading time
    ...
    BEGIN CATCH
        ...
        -- what we done:display the error details if the Silver load fails
